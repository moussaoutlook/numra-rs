...
`numra::ocp` instead (see [Parameter Estimation](../ch10-optimal-control/parameter-estimation.md)).
...
[Adjoint Methods](../ch10-optimal-control/adjoint-methods.md)) is more
