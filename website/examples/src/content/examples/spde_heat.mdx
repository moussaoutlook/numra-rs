...
complexity: advanced
order: 111
source_path: numra/examples/spde_heat.rs
source_link: https://github.com/moussaoutlook/numra-rs/blob/main/numra/examples/spde_heat.rs
...
```bash
cargo run --release --example spde_heat
```
