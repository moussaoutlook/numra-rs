...
- [Architecture Overview](./architecture-overview) -- understand how the
  crates fit together
- [Solving ODEs](../ch02-solving-odes/your-first-ode) -- deep dive into
  ODE solver selection and configuration
- [Solver Comparison](../ch02-solving-odes/solver-comparison) -- which
